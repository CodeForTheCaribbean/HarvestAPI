...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'farmers_farm', (
            ...
            ('farm_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ...
            ('farm_size', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('lat', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('long', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
