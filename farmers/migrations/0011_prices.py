...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'farmers_price', (
            ...
            ('crop_code', self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True)),
    ...
    models = {
        ...
        u'farmers.price': {
            ...
            'crop_code': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '5', 'null': 'True'}),
