...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Receipt', fields ['rec_range1', 'rec_range2']
        db.create_unique(u'farmers_receipt', ['rec_range1', 'rec_range2'])


    def backwards(self, orm):
        # Removing unique constraint on 'Receipt', fields ['rec_range1', 'rec_range2']
        db.delete_unique(u'farmers_receipt', ['rec_range1', 'rec_range2'])
    ...
    models = {
        ...
        u'farmers.receipt': {
            'Meta': {'unique_together': "(('rec_range1', 'rec_range2'),)", 'object_name': 'Receipt'},
