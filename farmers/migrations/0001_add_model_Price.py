...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Price'
        db.create_table(u'farmers_price', (
            ('price_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, primary_key=True)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default='', null=True, max_digits=10, decimal_places=2)),
            ('public', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True)),
            ('price_point', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('parish', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('commodity', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('crop_code', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('units', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('variety', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('batch_date', self.gf('django.db.models.fields.DateField')(default='', max_length=50, null=True)),
            ('published_on', self.gf('django.db.models.fields.DateField')(default='', max_length=50, null=True)),
            ('batch_publish_date', self.gf('django.db.models.fields.DateField')(default='', max_length=50, null=True)),
            ('extension', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
        ))
        db.send_create_signal(u'farmers', ['Price'])


    def backwards(self, orm):
        # Deleting model 'Price'
        db.delete_table(u'farmers_price')
    ...
    models = {
        ...
        u'farmers.crop': {
            ...
            'estimated_vol': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
        ...
        u'farmers.price': {
            'Meta': {'ordering': "('published_on',)", 'object_name': 'Price'},
            'batch_date': ('django.db.models.fields.DateField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'batch_publish_date': ('django.db.models.fields.DateField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'commodity': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'crop_code': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'extension': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'parish': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'price_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'primary_key': 'True'}),
            'price_point': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'public': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'null': 'True'}),
            'published_on': ('django.db.models.fields.DateField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'units': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'variety': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'})
        },
        u'farmers.receipt': {
