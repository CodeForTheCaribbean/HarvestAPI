...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'farmers_price', (
            ...
            ('crop_code', self.gf('django.db.models.fields.IntegerField')(default='', max_length=50, null=True)),
    ...
    models = {
        ...
        u'farmers.price': {
            ...
            'crop_code': ('django.db.models.fields.IntegerField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
