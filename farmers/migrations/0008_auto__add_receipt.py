...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'farmers_receipt', (
            ...
            ('receipt_no', self.gf('django.db.models.fields.CharField')(default='', max_length=10)),
            ('rec_range1', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
            ('rec_range2', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
            ('investigation_status', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
            ('remarks', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
        ))
