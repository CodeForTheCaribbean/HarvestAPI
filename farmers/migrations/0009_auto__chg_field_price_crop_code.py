...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Price.crop_code'
        db.alter_column(u'farmers_price', 'crop_code', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

    def backwards(self, orm):

        # Changing field 'Price.crop_code'
        db.alter_column(u'farmers_price', 'crop_code', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=0))
