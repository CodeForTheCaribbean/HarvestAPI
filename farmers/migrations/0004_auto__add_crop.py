...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'farmers_crop', (
            ...
            ('common_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
            ('estimated_vol', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('variety', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('plant_date', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('count', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('area', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('status', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('exp_date', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
    ...
    models = {
        ...
        u'farmers.crop': {
            ...
            'area': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'common_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
            'count': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'crop_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            'estimated_vol': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'exp_date': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'farm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['farmers.Farm']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plant_date': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'variety': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'})
        },
        u'farmers.farm': {
            ...
            'farm_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            'farm_size': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'long': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
