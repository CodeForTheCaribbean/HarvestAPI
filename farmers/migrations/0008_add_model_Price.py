...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'farmers_price', (
            ...
            ('crop_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
            ('crop_code', self.gf('django.db.models.fields.DecimalField')(default='', null=True, max_digits=5, decimal_places=0)),
            ('location', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('low', self.gf('django.db.models.fields.DecimalField')(default='', null=True, max_digits=10, decimal_places=2)),
            ('high', self.gf('django.db.models.fields.DecimalField')(default='', null=True, max_digits=10, decimal_places=2)),
            ('most_freq', self.gf('django.db.models.fields.DecimalField')(default='', null=True, max_digits=10, decimal_places=2)),
            ('week_ending', self.gf('django.db.models.fields.DateField')(default='', max_length=50, null=True)),
        ))
    ...
    models = {
        ...
        u'farmers.price': {
            'Meta': {'ordering': "('week_ending',)", 'object_name': 'Price'},
            'crop_code': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '5', 'decimal_places': '0'}),
            'crop_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True'}),
            'high': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'low': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'most_freq': ('django.db.models.fields.DecimalField', [], {'default': "''", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'week_ending': ('django.db.models.fields.DateField', [], {'default': "''", 'max_length': '50', 'null': 'True'})
        },
        u'farmers.receipt': {
